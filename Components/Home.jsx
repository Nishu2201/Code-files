...
import '../Styles/DataSec.css';
import '../Styles/Services.css';
import '../Styles/ServedField.css';
import '../Styles/Innovation.css';
import '../Styles/Cards.css';
import '../Styles/FlipCard.css';
// import '../Styles/Gallery1.css';
import '../Styles/ContactForm.css';
import '../Styles/How_it-work.css';
...
import Call from '../Images/Phone-icon.png';
...
import field from '../Images/solution_icon.svg';
...
import InnoPic from '../Images/Innovation-pic.png';
import techs from '../Images/techs.gif';
...
// import Mobile from '../Images/Innovation-pic.png';
const slides = [
  {
...
function Home() {
  ...
  const [navbarActive, setNavbarActive] = useState(false); // State to track navbar active state
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setNavbarActive(true); // Activate navbar on slide change
    }, 5000);
  ...
  //   setNavbarActive(true); // Activate navbar on click
  // };

  // // Function to deactivate navbar after animation ends
  // const handleNavbarTransitionEnd = () => {
  //   setNavbarActive(false);
  // };
  const handleHover = (index) => {
    const card = document.getElementById(`card-${index}`);
    card.style.backgroundColor = cardsData[index].color;
  };
  ...
  const cardsData = [
    { img: reactPic, title: 'React.js', description: 'The library for web and native user interfaces.' },
    { img: python, title: 'Python', description: 'High-level programming language' },
    { img: flutter, title: 'Flutter', description: 'Develop cross-platform applications with Flutter' },
    { img: nodePic, title: 'Node.js', description: 'Designed to build scalable network applications' },
    { img: html, title: 'HTML', description: 'Markup language for creating web pages' },
    { img: Css, title: 'CSS', description: 'Style sheet language for web development' },
  ];
  // How we work slider 
...
// useEffect for contactUs svg image icon
useEffect(() => {
  feather.replace(); // Replace feather icons on component mount
}, []);
  ...
  return (
    ...
    <section className="header-slider">
      <div className={`page-header section-dark ${navbarActive ? 'navbar-active' : ''}`}>
      ...
      {/* <div className="vertical-navbar" onTransitionEnd={handleNavbarTransitionEnd}>
        <ul>
          {slides.map((slide, index) => (
            <li key={index} className={currentSlide === index ? "active" : ""}>
              <a href="/" onClick={(e) => { e.preventDefault(); handleNavbarClick(index); } }>
                {slide.title}
              </a>
            </li>
          ))}
...
{/*       
      ...
      <section className='data'>
            ...
            <div className="text">Discover how to turn your concepts into <br />
                reality with a free consultation. Schedule now!</div>
            <div className='dataSec-row'>
              
                    <div className=' NO-data col-lg-3 col-md-4 col-sm-6 col-12'>
                        <h3>500+</h3>
                        <p>Happy Clients</p>
                    </div>
                    <div className=' NO-data col-lg-3 col-md-4 col-sm-6 col-12'>
      ...
      <section className="services">
          <div className="service-row1">
            <div className="col-lg-12 col-sm-12">
              <div
                className="mb-2 title_h2_new_head d-flex align-items-center wow fadeInUpSlide"
...
>
  Know more.
    ...
    {/* served filed code section here start */}
    <section className='data'>
    <div className="field">
...
<br/>
    ...
    {/* Innovation section start here */}
    {/* <div className="Innovation">
  <section className="Innovation-field">
    <div className="inno-row">
      <div className="col-lg-12">
        ...
        >
          <em className="Innovation_icon ">
            <img src={Innovation} alt="pics" width="30" className="img-fluid" />
          </em>
          <h2 className="Inno-text">Innovating Our Way Ahead!</h2>
        </div>
      </div>
    </div>
    <div className="inno-row">
      <div className="col-md-7" data-aos="fade-left">
        <div className="inno-field-row2">
          <h2>Pushing Boundaries, Shaping Futures With Our  Distinct Approach To The Digital World.</h2>
          <p
            className="light-black wow fadeInUpSlide"
            data-wow-duration="1s"
            data-wow-delay="0.4s"
          ...
          >
            We have spent the last decade sharpening our skills and providing path-breaking solutions. The 
            result? Over 2000 apps & games launched and 500+ clients served worldwide. Our client base, 
            which spans across the globe, stands as a testament to our ability to deliver results consistently.We are industry 
            experts in mobile & web solution development, and game design specialists offering top-notch games across genres.
          </p> 
        </div>
      </div>
      <div className="col-md-5" data-aos="fade-right">
        <img src={InnoPic} alt=""  className="InnovPic" />
      </div>
    </div>
  </section>
</div> */}
{/* Innovation section end here  */}

{/* Techs Cards code started here  */}
<div className="Techs-content">
      <section className="techs">
        <div className="techs-row1">
          <div className="col-lg-12 col-sm-12">
            <div
              className="mb-2 title_h2_new d-flex align-items-center wow fadeInUpSlide"
              data-wow-duration="1s"
              data-wow-delay="0.4s"
            >
              <em className="techs_icon bg-white">
                <img src={techs} alt="" width="30" className="img-fluid" />
              </em>
              <h2 className="tech-text">Other Quality Techs On Offer</h2>
            </div>
          </div>
        </div>
        <div className="techs-row2">
          <div className="text">
            <h2>We have much more to offer!</h2>
            <p className="techs-para">
              Explore our other fine quality techs and choose one that suits your needs.
            </p>
          </div>
        </div>
        <div className="techs_blocks">
  <div className="techs_blocks_row">
    {cardsData.slice(0, 3).map((card, index) => (
      <div
        ...
        onMouseOut={() => handleHoverOff(index)}
      >
        ...
        <div className="card-content">
          ...
          <p className="card-description">{card.description.split('\n').map((line, i) => <span key={i}>{line}<br /></span>)}</p>
        </div>
      </div>
    ))}
  </div>
  <div className="techs_blocks_row">
    {cardsData.slice(3).map((card, index) => (
      <div
        ...
        className="box-card"
        id={`card-${index + 3}`}
        onMouseOver={() => handleHover(index + 3)}
        onMouseOut={() => handleHoverOff(index + 3)}
      >
        <i className="icon-container">
          <img src={card.img} alt={card.title} className="card-icon" />
        </i>
    ...
    {/* cards section ended here  */}
    <div>
{/* 
    <section class="hire-us">
        <div class="container1">
            <div class="row1 justify-content-center align-items-center flex-column-reverse flex-sm-row">
                <div class="col-lg-5 col-md-6">
                    <div class="hire-us-onupwork">
                        <h5 class="h4 pb-3">
                            Hire us on <img src="https://www.chicmic.in/wp-content/themes/chicmic/img/node-js-new/upwork.png" alt="ChicMic" width="150"/>
                        </h5>
                        <h5 class="h4 pb-3">
                            We are among the top rated agencies on Upwork, providing full-fledged services to businesses
                            worldwide.
                        </h5>
                        <div class="d-flex align-items-center"><a href="https://www.upwork.com/o/companies/~019752cb843ab06414/">Click here to view our
                                Profile</a>
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="work-completed">
                        <div class="row2 justify-content-center mb-4">
                            <div class="col-md-5 Jobs-Completed">
                                <h3 class="h3">1400<small>+</small></h3>
                                <p>Jobs-Completed</p>
                            </div>
                            <div class="col-md-5 Total-Earned">
                                <h3 class="h3">$7M</h3>
                                <p>Total Earned</p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-md-10 Talent">
                                <h3 class="h3">In Top 12% Talent</h3>
...
create robust solutions that exceed expectations.</p>
              ...
              <div className="work_place">
                  <div className="effect">
                    <em><img src="https://www.chicmic.in/wp-content/uploads/2024/02/Plan-Strategize.svg" alt="" /></em>
                    <div className="d-flex justify-content-center">
                      <h3>Plan &amp; Strategize    </h3>
                    </div>
                  </div>
                  <div className="work_max">
                    <p>Our experienced project managers work closely with you to create a detailed plan and strategy that aligns with your goals. To ensure efficient execution, 
                    we break down the project into smaller, more manageable components.</p>
                  </div>
                </div>
              </div> */}
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none" className="Contact-image">
    <g id="Image">
        <g id="g14">
            <g id="g16">
                <g id="g22">
...
<form>
        <p className="contact-title">Talk to Us</p>

        <div className="form-group">
          <FiUser className="inputiconicon" />
        ...
        <div className="form-group message">
          <textarea id="formMessage" className="form-control form-control-lg" rows="7" placeholder="Your Massage..."></textarea>
        </div>
...
{/* <div className="Project-Gallery"><Gallery/></div> */}
				...
				{/* <section className="how_it_work">
      <div className="work-container">
        <div className="chose_rht mb-2 title_h2_new d-flex align-items-center wow fadeInUpSlide" data-wow-duration="1s" data-wow-delay="0.4s">
          <em className="work_icon">
            <img src="https://www.chicmic.in/wp-content/themes/chicmic/img/android/how_work_icon.svg" alt="Requirement" width="30" className="img-fluid" />
          </em>
          <h2 className="h4 mb-0">How it Works</h2>
        </div>
        <h2 className="wow fadeInUpSlide" data-wow-duration="1s" data-wow-delay="0.4s">We put the work into your idea, and here’s how we do it!</h2>
        ...
        <div className="work_part slick_dot_space slick-initialized slick-slider slick-dotted" id="services-slider">
            ...
            <div className="slick-track">
              <div className="slick-slide slick-current slick-active" data-slick-index="0">
                <div className="work_place">
                  ...
                  <div className="work_max">
                    <p>We are a team of passionate developers who will sit with you to hear your idea and offer applicable solutions for it.</p>
                  </div>
                </div>
              </div>

              <div className="slick-slide" data-slick-index="1">
                <div className="work_place">
                  <div className="effect">
                    <em><img src="https://www.chicmic.in/wp-content/uploads/2024/02/Iterations.svg" alt="" /></em>
                    <div className="d-flex justify-content-center">
                  ...
                  <div className="work_max">
                    <p>We believe in continuous improvement and iterate on the application based on user feedback and data analysis. Our expert team collects valuable data from users, conducts thorough analysis, 
                      and uses insights to identify areas for enhancement and optimization.</p>
                  </div>
                </div>
              </div>

              <div className="slick-slide" data-slick-index="2">
              <div className="work_place">
                  <div className="effect">
                    <em><img src="https://www.chicmic.in/wp-content/uploads/2024/02/Conceptualization.svg" alt="" /></em>
                    <div className="d-flex justify-content-center">
                  ...
                  <div className="work_max">
                    <p>Based on your ideas, our team proceeds with conceptualization. It allows everyone to understand how the project should look like. 
                    The process also gives you a clear picture of the end product.</p>
                  </div>
                </div>
              </div>

              <div className="slick-slide" data-slick-index="3">
              <div className="work_place">
                  <div className="effect">
                    <em><img src="https://www.chicmic.in/wp-content/uploads/2024/02/Plan-Strategize.svg" alt="" /></em>
                    <div className="d-flex justify-content-center">
              ...
              <div className="slick-slide" data-slick-index="4">
              <div className="work_place">
                  <div className="effect">
                    <em><img src="https://www.chicmic.in/wp-content/uploads/2024/02/Development-Cycle.svg" alt="" /></em>
                    <div className="d-flex justify-content-center">
                  ...
                  <div className="work_max">
                    <p>Our project managers closely collaborate between different 
                      teams to ensure the timely delivery of projects that exceed expectations.</p>
                  </div>
                </div>
              </div>

              <div className="slick-slide" data-slick-index="5">
              <div className="work_place">
                  <div className="effect">
                    <em><img src="https://www.chicmic.in/wp-content/uploads/2024/02/Launch.svg" alt="" /></em>
                    <div className="d-flex justify-content-center">
                  ...
                  <div className="work_max">
                    <p>At Chicmic, we provide comprehensive support for app deployment
                       on all major platforms along with marketing, and growth services.</p>
                  </div>
                </div>
              </div>
          ...
          <ul className="slick-dots" role="tablist">
            <li className="slick-active" role="presentation">
              <button type="button" role="tab" aria-controls="slick-slide40" aria-label="1 of 6" tabIndex="0" aria-selected="true">1</button>
            </li>
            <li role="presentation" className="">
              <button type="button" role="tab" aria-controls="slick-slide41" aria-label="2 of 6" tabIndex="-1">2</button>
            </li>
            <li role="presentation" className="">
              <button type="button" role="tab" aria-controls="slick-slide41" aria-label="3 of 6" tabIndex="-1">3</button>
            </li>
            <li role="presentation" className="">
              <button type="button" role="tab" aria-controls="slick-slide41" aria-label="4 of 6" tabIndex="-1">4</button>
            </li>
            <li role="presentation" className="">
              <button type="button" role="tab" aria-controls="slick-slide41" aria-label="5 of 6" tabIndex="-1">5</button>
            </li>
            <li role="presentation" className="">
              <button type="button" role="tab" aria-controls="slick-slide41" aria-label="6 of 6" tabIndex="-1">6</button>
            </li>
          </ul>
        </div>
      </div>
                ...
                <div className="custom-section-content">
                    ...
                    {/* <div className="custom-section-button"> */}
                        <button type="button"  className="ChooseUs-btn">
                            <em><img src={Call} alt="" width="300" className="ChooseUs-img" /></em>
   ...
   <div className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-section contact">
          ...
          <p className="footer-contact-para"><FontAwesomeIcon icon={faMapMarkerAlt} /> AIRAI TECHNOLOGIES PVT. LTD.<br/> F-177, KAILASH TOWER, PHASE 8B, MOHALI, PB</p> 
          <p className="footer-contact-para"><FontAwesomeIcon icon={faEnvelopeSquare} />  contact@airai.games</p>
          <p className="footer-contact-para"> <FontAwesomeIcon icon={faPhone} /> +1 234 567 890</p>
        </div>
      </div>
      {/* 
